...
public class DateUtil {
	 ...
	 * 
	 * @param dateAsString
	 *            string formatted date (ex. 11/06/2017 : DD/MM/YYYY)
	 ...
	 * 
	 * @param date
	 *            Dare object to be converted to String
	...
	/**
	 * This method returns Year and Month for given Date in format : Ex. 2017,01
	 * ; 2017,02 so on ...
	 * 
	 * @param date
	 *            year and month will be extracted for this date
	 * @return return year and month for input date
	 */
	public static String getYearAndMonth(Date date) {
		SimpleDateFormat df = new SimpleDateFormat("yyyy,MM");// Ex.2016,01,
																// 2016,02
		return df.format(date);
	}
	...
	/**
	 * This method returns Months Name for given month number 01:Jan,
	 * 02:Feb...., 12:Dec
	 * 
	 * @param monthNo
